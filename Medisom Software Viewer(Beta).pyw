...
def mapa2D(X, Y, Z, intes, disco, radius):
        ...
        ax.text(r +3.5, (r/2) - 10 ,'0,00 V -| 0,25 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 8.9 ,'0,25 V -| 0,50 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 7.9 ,'0,50 V -| 0,76 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 6.9 ,'0,76 V -| 1,01 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 5.9 ,'1,01 V -| 1,26 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 4.9 ,'1,26 V -| 1,52 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 3.9 ,'1,52 V -| 1,77 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 2.9 ,'1,77 V -| 2,03 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 1.9 ,'2,03 V -| 2,28 V', fontsize=8)
        ax.text(r +3.5, (r/2)- 0.9,'2,28 V -| 2,53 V', fontsize=8)
        ax.text(r +3.5, (r/2) ,'2,53 V -| 2,79 V', fontsize=8)
        ax.text(r +3.5, (r/2)+0.9 ,'2,79 V -| 3,04 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 1.9 ,'3,04 V -| 3,29 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 2.9 ,'3,29 V -| 3,55 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 3.9 ,'3,55 V -| 3,80 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 4.9 ,'3,80 V -| 4,06 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 5.9 ,'4,06 V -| 4,31 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 6.9 ,'4,31 V -| 4,56 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 7.9 ,'4,56 V -| 4,82 V', fontsize=8)
        ax.text(r +3.5, (r/2)+ 8.9 ,'4,82 V -| 5,00 V', fontsize=8)
        for p in [
